...
static interrupt_handler RB5_High_InterruptHandler=((void*)0);
static interrupt_handler RB5_Low_InterruptHandler=((void*)0);

static interrupt_handler RB6_High_InterruptHandler=((void*)0);
static interrupt_handler RB6_Low_InterruptHandler=((void*)0);

static interrupt_handler RB7_High_InterruptHandler=((void*)0);
static interrupt_handler RB7_Low_InterruptHandler=((void*)0);
...
# 70 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
Std_RetrunType interrupt_INTx_Init(const interrupt_INTx_t *intr_obj){
...
Std_RetrunType interrupt_RBx_Init(const interrupt_RBx_t *intr_obj){
    ...
    else
    {
        ...
        INTCONbits.RBIF=0;
        (INTCONbits.RBIE=0);
# 152 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
        (INTCONbits.GIE=1);
        (INTCONbits.PEIE=1);
...
# 269 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE=1);
                (INTCONbits.PEIE=1);
...
# 367 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static Std_RetrunType interrupt_INTx_edge_set(const interrupt_INTx_t *intr_obj){
    Std_RetrunType ret = ((Std_RetrunType) 0x01);
    if(intr_obj == ((void*)0) )
    {
...
# 509 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static Std_RetrunType INT1_set_interrupt_handler(void(*interrupt_handler)(void)){
    Std_RetrunType ret = ((Std_RetrunType) 0x00);
    if(interrupt_handler == ((void*)0) )
    {
...
# 625 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
void RB4_ISR(uint8 state){
    (INTCONbits.RBIF=0);
    if(state==0){
