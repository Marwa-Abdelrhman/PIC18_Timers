...
# 13 "MCAL_Layer/Timer/hal_timer2.h"
...
static uint8 timer2Preload_val;
  ...
  static void (* TIMER2_Set_Interrupt_Handler)(void) =((void*)0);
...
Std_RetrunType TIMER2_Init(const timer2_t *tmr2_obj){
    ...
    {
       (T2CONbits.TMR2ON=0);
       (T2CONbits.T2CKPS=tmr2_obj->prescaler_value);
       (T2CONbits.TOUTPS=tmr2_obj->postscaler_value);
     ...
     (PIE1bits.TMR2IE=1);
     (PIR1bits.TMR2IF=0);
# 47 "MCAL_Layer/Timer/hal_timer2.c"
 (INTCONbits.GIE=1);
 (INTCONbits.PEIE=1);
...
Std_RetrunType TIMER2_read_value(const timer2_t *tmr2_obj,uint8 *tmr2_val){
    ...
    if(tmr2_obj == ((void*)0) || tmr2_val==((void*)0) )
    {
        ret=((Std_RetrunType) 0x00);
    }
    else
