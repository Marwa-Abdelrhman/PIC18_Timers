...
# 11 "MCAL_Layer/Timer/../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/Timer/../GPIO/../compilers.h" 1
# 14 "MCAL_Layer/Timer/../GPIO/../compilers.h"
...
# 14 "MCAL_Layer/Timer/../GPIO/../compilers.h" 2
# 11 "MCAL_Layer/Timer/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_Layer/Timer/../GPIO/../std_libraries.h" 1
# 16 "MCAL_Layer/Timer/../GPIO/../std_libraries.h"
...
# 16 "MCAL_Layer/Timer/../GPIO/../std_libraries.h" 2
...
# 18 "MCAL_Layer/Timer/../GPIO/../std_libraries.h" 2
# 12 "MCAL_Layer/Timer/../GPIO/../mcal_std_types.h" 2
# 21 "MCAL_Layer/Timer/../GPIO/../mcal_std_types.h"
...
# 40 "MCAL_Layer/Timer/../GPIO/hal_gpio.h"
typedef enum{
...
# 17 "MCAL_Layer/Timer/../Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h" 1
# 19 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_generated_cfg.h" 1
# 19 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h" 2
# 54 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 17 "MCAL_Layer/Timer/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MCAL_Layer/Timer/hal_timer0.h" 2
# 41 "MCAL_Layer/Timer/hal_timer0.h"
typedef enum{
...
static uint16 timer0Preload_val;
  ...
  static void (* TIMER0_Set_Interrupt_Handler)(void) =((void*)0);


static __attribute__((inline)) void configure_timer0_prescaler_value(const timer0_t *timer0_obj);
static __attribute__((inline)) void configure_timer0_mode(const timer0_t *timer0_obj);
static __attribute__((inline)) void configure_timer0_reg_size(const timer0_t *timer0_obj);
...
Std_RetrunType TIMER0_Init(const timer0_t *timer0_obj){
    ...
    else
    {
     ...
     (INTCONbits.TMR0IE=1);
     (INTCONbits.TMR0IF=0);
# 61 "MCAL_Layer/Timer/hal_timer0.c"
 (INTCONbits.GIE=1);
 (INTCONbits.PEIE=1);
...
Std_RetrunType TIMER0_read_value(const timer0_t *timer0_obj,uint16 *timer0_val){
    Std_RetrunType ret = ((Std_RetrunType) 0x00);
    uint8 l_timer0_L=0,l_timer0_H=0;

    if(timer0_obj == ((void*)0) || timer0_val==((void*)0) )
    {
        ret=((Std_RetrunType) 0x00);
    }
    else
...
static __attribute__((inline)) void configure_timer0_prescaler_value(const timer0_t *timer0_obj){
    if(timer0_obj->prescaler_cfg==1){
        (T0CONbits.PSA=0);
        T0CONbits.T0PS=timer0_obj->prescaler_value;
    }
    else if(timer0_obj->prescaler_cfg==0){
        (T0CONbits.PSA=1);
    }
    else{ }
...
static __attribute__((inline)) void configure_timer0_mode(const timer0_t *timer0_obj){
    if(timer0_obj->timer0_mode == 1){
        (T0CONbits.T0CS=0);
    }
    else if(timer0_obj->timer0_mode == 0){
        (T0CONbits.T0CS=1);

        if(timer0_obj->counter_edge_cfg==0){
            (T0CONbits.T0SE=0);
        }
        else if(timer0_obj->counter_edge_cfg==0){
            (T0CONbits.T0SE=1);
        }
    }
    else{ }
...
static __attribute__((inline)) void configure_timer0_reg_size(const timer0_t *timer0_obj){
    if(timer0_obj->timer0_reg_size == 0){
        (T0CONbits.T08BIT=0);
    }
    else if(timer0_obj->timer0_reg_size == 1){
        (T0CONbits.T08BIT=1);
    }
    else{ }
}
